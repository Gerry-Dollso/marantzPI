...
const oldCheckpoint = 'Current tested functional checkpoint:\n\n' +
  fencedText(['fc418d2 — Upgrade TIDAL My Music albums browsing']);
const newCheckpoint = 'Current tested functional checkpoint:\n\n' +
  fencedText(['a65f1b5 — Add rich personalised TIDAL landing cards']);
readme = replaceOnce(readme, oldCheckpoint, newCheckpoint, 'README current checkpoint block');
...
readme = replaceOnce(readme, '## Current feature set', readmeSection, 'README feature heading');
